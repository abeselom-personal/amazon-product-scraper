...
module.exports = {
    ...
    scraper: {
        ...
        defaultMaxPages: parseInt(process.env.DEFAULT_MAX_PAGES || '9999', 10),
        hardMaxPages: parseInt(process.env.HARD_MAX_PAGES || '99999', 10),
        userAgents: [
    ...
    export: {
        topN: parseInt(process.env.EXPORT_TOP_N || '99999', 10),
